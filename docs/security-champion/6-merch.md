...
- `Lanyard`: A stylish card holder to show you are part of the Security Champion Network
- `Pins`: Decorate your lanyard to show off your Security Champion status
...
!!! note
    ...
    Merch will "build up" and be shipped in bulk in order to avoid too much shipping work.
